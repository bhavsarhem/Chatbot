...
chatbot_name = "Virtual Assistant"

# Streamlit UI setup
st.set_page_config(page_title=f"{chatbot_name}", page_icon="img/gipl_header_logo.png")
st.logo("img/logo.png") # if you want add logo of you brand/company replace logo.png with your logo image file.
st.title(f"Welcome to {chatbot_name}!")
st.caption("Ask me anything about our website!")
...
print(pdf_paths)
website_urls = [
    # if want Crawl website data add that website's Full url here 
    'https://google.com',
    ]
